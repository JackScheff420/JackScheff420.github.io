            ...
            <section id="impressum" className="bg-theme min-h-screen pt-36 flex flex-col items-start">
                <div className="container mx-auto max-w-6xl p-4 md:p-16 border-theme border-2 rounded-xl">
                    ...
                    <p className="font-semibold text-base md:text-lg lg:text-xl text-theme mb-2 md:mb-3">
                        ...
                        <br/>
                        Diese Haftungsausschlusserklärung gilt auch innerhalb des eigenen Internetauftrittes jackscheff420.github.io gesetzten Links und Verweise von Fragestellern, Blogeinträgern, Gästen des Diskussionsforums. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargestellten Informationen entstehen, haftet allein der Diensteanbieter der Seite, auf welche verwiesen wurde, nicht derjenige, der über Links auf die jeweilige Veröffentlichung lediglich verweist.
                        <br/>
